  ...
  <body class="single single-post"> 
	...
	<div id="headerwrap" class="half">
   		<div class="container">
        	...
        	<div id="bannertext" class="centered fade-down section-heading">
                <h2 class="main-title">Single Post Sidebar</h2>
                <hr>
	...
	<div id="content-wrapper">
   		<div class="container">
			...
			<div class="row gap">
				<div class="col-md-9">
					<div class="col-md-2 fade-left nopadding">
						<p><img src="assets/img/team/team1.jpg" alt="" class="img-responsive" /></p>
						<p class="post-details">Author <strong>John Smtih</strong></p>
						<p class="post-details">Published <strong>14th July 2014</strong></p>
						<p class="post-details">Category <strong>News</strong></p>
						<p class="post-details">Tagged  <strong>Blog, Post, Item</strong></p>						
					</div>
					...
					<div class="col-md-10 post-content">
						...
						<div id="sharebox" class="btn-group mt gap fade-up">
						...
						<nav class="mt gap fade-up">
							<ul class="post-navigation">			
								<li class="nav-previous previous previous-post">
									<h4 class="post-nav-title">Previous Post</h4>
									<a href="#" rel="prev">Another Wonderful Post</a>
								</li>			
								<li class="nav-next next next-post">
									<h4 class="post-nav-title">Next Post</h4>
									<a href="#" rel="next">Another Wonderful Post</a>
								</li>			
							</ul>
						</nav>
			        	...
			        	<div class="centered gap fade-down section-heading">
			                ...
			                <hr>
			                <p>3 Comments on - <span>Single Post</span></p>
			            </div>
	                        ...
	                        <div id="comments-list gap">
	                            <div class="media">
	                                <div class="pull-left fade-right">
	                                    <img class="avatar comment-avatar" src="assets/img/team/team2.jpg0" alt="">
	                                </div>
	                                <div class="media-body fade-left">
	                                    ...
	                                    <div class="media">
	                                        <div class="pull-left">
	                                            <img class="avatar comment-avatar" src="assets/img/team/team3.jpg" alt="">
	                                        </div>
	                            ...
	                            <div class="media">
	                                <div class="pull-left fade-right">
	                                    <img class="avatar comment-avatar" src="assets/img/team/team4.jpg" alt="">
	                                </div>
	                                <div class="media-body fade-left">
	                                    <div class="well">
	                                        <div class="media-heading">
				...
				<div id="main-sidebar" class="col-md-3 fade-right">
					<div class="widget">
                    <h4 class="widget-title">Latest Posts</h4>
                        <div>
                            <div class="media">
                                <div class="pull-left">
                                    <img class="widget-img" src="assets/img/demo/2.jpg" width="80" alt="">
                                </div>
                                <div class="media-body">
                                    <span class="media-heading"><a href="#">Blog Post A</a></span>
                                    <small class="muted"><i class="fa fa-clock-o"></i> Posted 14 April 2014</small>
                                </div>
                            </div>
                            <div class="media">
                                <div class="pull-left">
                                    <img class="widget-img" src="assets/img/demo/3.jpg" width="80" alt="">
                                </div>
                                <div class="media-body">
                                    <span class="media-heading"><a href="#">Blog Post A</a></span>
                                    <small class="muted"><i class="fa fa-clock-o"></i> Posted 14 April 2014</small>
                            ...
                            <div class="media">
                                <div class="pull-left">
                                    <img class="widget-img" src="assets/img/demo/4.jpg" width="80" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media">
                                <div class="pull-left">
                                    <img class="widget-img" src="assets/img/demo/5.jpg" width="80" alt="">
                                </div>
                                <div class="media-body">
                                    <span class="media-heading"><a href="#">Blog Post A</a></span>
                                    <small class="muted"><i class="fa fa-clock-o"></i> Posted 14 April 2014</small>
                            ...
                            <div class="media">
                                <div class="pull-left">
                                    <img class="widget-img" src="assets/img/demo/6.jpg" width="80" alt="">
                                </div>
                                <div class="media-body">
                                    <span class="media-heading"><a href="#">Blog Post A</a></span>
                                    <small class="muted"><i class="fa fa-clock-o"></i> Posted 14 April 2014</small>
